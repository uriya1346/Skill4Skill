...
function RentalAdminCatList(props){
let [ar,setAr] = useState([]);
  ...
  return(
    <div className='container mb-5'>
      ...
      <h1 className='gradi text-center'><i className="fa fa-lastfm me-4 mb-4" aria-hidden="true"></i>Rental Categories panel</h1>
      <table className='table table-bordered table-dark table-striped table-responsive flex-md-column-reverse col-lg-6 my-5 text-center'>
        ...
        <div className='d-flex justify-content-between mx-md-5'>
          <div>
      <Link to="/admin/addRentalCategory" className="btnTable">Add new category<i className="fa fa-plus mx-2 mb-3" aria-hidden="true"></i></Link> 
      </div>
      <div>
      <Link to="/admin/addRentalProduct" className="btnTable">Add new car<i className="fa fa-plus mx-2 mb-3" aria-hidden="true"></i></Link> 
      </div>
      </div>
...
export default RentalAdminCatList