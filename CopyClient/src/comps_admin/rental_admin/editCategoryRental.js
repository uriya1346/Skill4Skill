...
function EditCategoryRental(props){
  ...
  const doApi = async() => {
    let urlProduct = API_URL+ "/categoriesRental/single/"+params.url_name;
   ...
   const doFormApi = async (formData) => {
     let url = API_URL + "/categoriesRental/"+category._id;
     try {
...
export default EditCategoryRental