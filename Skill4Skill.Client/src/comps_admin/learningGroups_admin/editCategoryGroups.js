...
function EditGroupsCatAdmin(props){
  ...
  const doApi = async() => {
    let urlProduct = API_URL+ "/categoriesGroup/single/"+params.url_name;
   ...
   const doFormApi = async (formData) => {
     let url = API_URL + "/categoriesGroup/"+category._id;
     try {
...
export default EditGroupsCatAdmin